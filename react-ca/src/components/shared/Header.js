                        ...
                        <div className="ml-auto flex justify-center item-center">
                            <div className="space-x-2 lg:space-x-8 flex flex-1 justify-center items-center">
                                    <NavLink to="/"
                                        ...
                                        <span className="h-6 w-px lg:space-x-8  bg-gray-200" aria-hidden="true"></span>
                                    <NavLink to="/contact" className="text-[20px] lg:space-x-8  justify-center item-center font-medium text-gray-700 hover:text-gray-800">Contact</NavLink>
                            </div>
