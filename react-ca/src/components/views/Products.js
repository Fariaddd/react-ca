                  ...
                  <div className='mt-4 flex justify-between'>
                    <div>
                      <h2 className='text-sm text-gray-700'>
                        <Link to={`product/${product.id}`} className='relative text-lg font-semibold text-white'>
                          <span aria-hidden="true" className='absolute  inset-0'/>
                            {product.title}
                        </Link> 
                      </h2>
                      <Link to={`product/${product.id}`}>
                      <p  className='mt-0.5  text-lg font-semibold text-white'>{product.description}</p>
                      </Link>
                    </div>
